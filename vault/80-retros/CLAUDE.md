# support-ai — Claude Code Configuration

## Project Overview

AI-powered support-to-PR automation. Converts support tickets into pull requests with human gates at plan approval and PR merge.

**Goal:** Reduce ticket resolution from 1-5 days to <15 minutes.
...
| PRD | `vault/30-bmad/support-ai-prd.md` |
| Architecture | `vault/30-bmad/architecture/support-ai-architecture.md` |
| UX spec | `vault/30-bmad/ux/support-ai-ux.md` |
...
- Use `nx-workspace` skill to query projects, targets, dependencies
- Prefer `npm nx run` / `npm nx run-many` over direct tooling
- For generators, use `nx-generate` skill first
...
- Schemas in `vault/30-bmad/architecture/support-ai-architecture.md` §5
